...
public class MeetingController {
    ...
    //미팅 목록 조회
    public ResponseEntity<ApiResponse<List<MeetingListResponseDto>>> getMeetingList(@RequestParam long studyId,
                                                                                    @AuthenticationPrincipal CustomUserDetails customUserDetails) {
    ...
    //미팅 상세 조회
    public ResponseEntity<ApiResponse<MeetingDetailResponseDto>> getMeetingDetail(@RequestParam long meetingId,
                                                                                  @AuthenticationPrincipal CustomUserDetails customUserDetails) {
    ...
    //미팅 출석
    public ResponseEntity<ApiResponse<Void>> attendanceMeeting(@RequestParam long meetingId,
                                                               @AuthenticationPrincipal CustomUserDetails customUserDetails) {
